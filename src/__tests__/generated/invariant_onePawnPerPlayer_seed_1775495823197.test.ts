...
// Details: Player 1 has 2 pawns in their domain (max 1)
// Seed: 1775495823197, Players: 3
import { describe, it, expect } from 'vitest';
import { createInitialState, gameReducer } from '../../engine/gameStateMachine';
import type { KredAction } from '../../engine/types';

describe('invariant violation: onePawnPerPlayer (seed 1775495823197)', () => {
  it('replays the failing game', () => {
    let state = createInitialState({ playerCount: 3 as const, seed: 1775495823197 });
