...
// Details: p2_rostrum2 is occupied but none of its supporting seats [p2_seat4, p2_seat5, p2_seat6] are occupied
// Seed: 3, Players: 3
import { describe, it, expect } from 'vitest';
import { createInitialState, gameReducer } from '../../engine/gameStateMachine';
import type { KredAction } from '../../engine/types';

describe('invariant violation: supportRule (seed 3)', () => {
  it('replays the failing game', () => {
    let state = createInitialState({ playerCount: 3 as const, seed: 3 });
